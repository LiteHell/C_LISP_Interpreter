...
#define LISP_SYMBOL_FUNC_COUNT 9
#define LISP_SYMBOL_FUNC_NAMES "ATOM", "NULL", "NUMBERP", "ZEROP", "MINUSP", "EQUAL", "<", ">=", "STRINGP"
#define LISP_SYMBOL_FUNCS fn_atom, fn_null, fn_numberp, fn_zerop, fn_minusp, fn_equal, fn_lessthan, fn_greaterOrEqualThan, fn_stringp
#endif