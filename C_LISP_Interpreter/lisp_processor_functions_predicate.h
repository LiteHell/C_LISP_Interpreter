...
#define LISP_PREDICATE_FUNC_COUNT 12
#define LISP_PREDICATE_FUNC_NAMES "ATOM", "NULL", "NUMBERP", "ZEROP", "MINUSP", "EQUAL", "<", ">=", ">", "<=", "=", "STRINGP"
#define LISP_PREDICATE_FUNCS fn_atom, fn_null, fn_numberp, fn_zerop, fn_minusp, fn_equal, fn_lessthan, fn_greaterOrEqualThan, fn_greaterthan, fn_lessOrEqualThan, fn_equalOp, fn_stringp
#endif